    ...
    export function WeeklyExercisesSettings() {
      ...
      return (
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Weekly Exercises Settings</h2>
    
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-900 mb-2">Add New Exercise</h3>
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-2">Current Exercises</h3>
