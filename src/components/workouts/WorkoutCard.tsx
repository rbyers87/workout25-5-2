import React, { useState, useEffect } from 'react';
    ...
    export function WorkoutCard({ workout, onDelete }: WorkoutCardProps) {
      ...
      return (
        <div className="bg-white dark:bg-darkBackground text-gray-900 dark:text-gray-200 rounded-lg shadow-md p-6 transition-all duration-300">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{workout.name}</h3>
              {workout.description && (
              ...
              exercises?.map((exercise) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 dark:text-gray-100">{exercise.exercise.name}</p>
          ...
          <div className="mt-6 flex justify-end space-x-4">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-white ${
                isCompleted
                  ? 'bg-gray-500 hover:bg-gray-600 dark:bg-gray-400 dark:hover:bg-gray-500'
